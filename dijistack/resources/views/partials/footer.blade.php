        <footer class="footer-style1 pb-50px">
            <div class="container">
                <div class="row sm-marg">
                        ...
                        <div class="fo-box-left v-align-between">
                            <div>
                                <div
                                    ...
                                    <div>
                                        <h2><span class="opacity-7">Projeniz için bizimle iletişime geçin.En kısa sürede
                                                size dönüş yapalım.</span></h2>
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-end justify-content-between">
                                    <div>
                                        ...
                                        <p class="fs-14 text-uppercase fw-200">
                                            © 2026 <a href="">Dijistack</a>. Tüm Hakları Saklıdır.
                                        </p>
                                    </div>
                    ...
                    <div class="col-lg-4" data-ui-animate data-delay="0.4">
                        <div class="fo-box-right d-flex v-align-between">
                            ...
                            <div class="subscribe">
                                <h6 class="fs-14 mb-15px"><i class="fa-solid fa-envelope mr-10px"></i>
                                    Bülten</h6>
                                <form action="#" class="position-relative">
                                    <input type="email" placeholder="E-Posta Adresinizi Giriniz..." name="subscribe">
                                    <button type="submit"><img src="assets/imgs/paper-plane.svg" alt=""
                                            class="w-30px"></button>
                                </form>
                                <p class="fs-14 mt-15px">Abone olarak <a href="#0"
                                        class="underline">Gizlilik Politika</a>'sını kabul etmiş olursunuz.</p>
                            </div>
                        </div>
                    </div>
                </div>
